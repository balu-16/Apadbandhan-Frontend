        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md mb-6">
              AIoT-based accident detection and emergency response platform. 
              Saving lives through rapid response and advanced technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <span>support@apadbandhav.com</span>
              </li>
              <li className="flex items-center gap-3 text-muted-foreground">
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">
              © {new Date().getFullYear()} Apadbandhav. All rights reserved.
            </p>
